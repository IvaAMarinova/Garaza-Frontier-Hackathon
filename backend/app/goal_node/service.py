...
Return exactly three concise plain-text sentences (≤30 words each) that:
...
class GoalNodeService:
    ...
    async def _generate_initial_goal(self, session_id: str) -> GoalNode:
        ...
        user_prompt = textwrap.dedent(
            ...
            - Output exactly three plain-text, third-person sentences (each ≤30 words, no brackets, ellipses, or enumerations) and ensure the final sentence is complete.
            """
        ).strip()
