...
export function useMindMap(initialText) {
    ...
    const [nodes, setNodes] = useState([
        Object.assign(Object.assign({}, INITIAL_CENTER_NODE), { content: { text: initialText || "" }, color: CENTER_COLOR.light }),
    ]);
    // Drag state
    ...
    const connections = useMemo(() => {
        ...
        return nodes
            ...
            const strokeColor = isDarkMode
                ? (colorData === null || colorData === void 0 ? void 0 : colorData.darkConnection) || CENTER_COLOR.darkConnection
                : (colorData === null || colorData === void 0 ? void 0 : colorData.connection) || CENTER_COLOR.connection;
            return {
                id: node.id,
