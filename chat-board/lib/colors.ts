export const NODE_COLORS = [
  ...
  {
    light:
      "border-purple-300 bg-purple-50/80 text-purple-900 dark:border-purple-700 dark:bg-purple-950/50 dark:text-purple-100",
    connection: "#d8b4fe",
  ...
  {
    light:
      "border-amber-300 bg-amber-50/80 text-amber-900 dark:border-amber-700 dark:bg-amber-950/50 dark:text-amber-100",
    connection: "#fcd34d",
    darkConnection: "#92400e",
  },
  {
    light:
      "border-green-300 bg-green-50/80 text-green-900 dark:border-green-700 dark:bg-green-950/50 dark:text-green-100",
    connection: "#86efac",
  ...
  {
    light:
      "border-orange-300 bg-orange-50/80 text-orange-900 dark:border-orange-700 dark:bg-orange-950/50 dark:text-orange-100",
    connection: "#fdba74",
...
export const CENTER_COLOR = {
  light:
    "border-slate-400 bg-slate-100/90 text-slate-900 dark:border-slate-600 dark:bg-slate-800/90 dark:text-slate-100",
  connection: "#cbd5e1",
